...
class Styles {
  ///---------------------------黑绿色字体区域-------------------------------
  static const TextStyle style_1A2F51_14 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 14,
  );
  static const TextStyle style_1A2F51_16 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 16,
  );
  static const TextStyle style_1A2F51_18 = TextStyle(
    color: ColorStyle.color_1A2F51,
    fontSize: 18,
  );

  ///---------------------------淡灰色字体区域-------------------------------
  static const TextStyle style_B8C0D4_11 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 11,
  );
  static const TextStyle style_B8C0D4_13 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 13,
  );
  static const TextStyle style_B8C0D4_14 = TextStyle(
    color: ColorStyle.color_B8C0D4,
    fontSize: 14,
  );

  ///---------------------------浅灰色字体区域-------------------------------
  static const TextStyle style_9F9EA6_11 = TextStyle(
  ...
  static const TextStyle style_616169_11 = TextStyle(
    color: Color(0xff616169),
    fontSize: 11,
    height: 1.1,
  );
  static const TextStyle style_6A6969_14 = TextStyle(
    color: ColorStyle.color_6A6969,
    fontSize: 14,
  );
  static const TextStyle style_6A6969_16 = TextStyle(
    color: ColorStyle.color_6A6969,
    fontSize: 16,
  );

  ///---------------------------白色字体区域-------------------------------
  static const TextStyle style_white_10 = TextStyle(
    color: Colors.white,
    fontSize: 10,
    height: 1.1,
  );
  ...
  static const TextStyle style_white_16 = TextStyle(
    color: Colors.white,
    fontSize: 16,
  );
  static const TextStyle style_white_18 = TextStyle(
    color: Colors.white,
    fontSize: 18,
  );
  ...
  static const TextStyle style_white_36 = TextStyle(
    color: Colors.white,
    fontSize: 36,
  );
  ...
  static const TextStyle style_black_14 = TextStyle(
    color: Colors.black,
    fontSize: 14,
  );
  static const TextStyle style_black_16 = TextStyle(
    color: Colors.black,
    fontSize: 16,
  );
  static const TextStyle style_black_36 = TextStyle(
    color: Colors.black,
    fontSize: 36,
  );
  static const TextStyle style_black_30 = TextStyle(
    color: Colors.black,
    fontSize: 30,
  );
  static const TextStyle style_black_12 = TextStyle(
    color: Colors.black,
    fontSize: 12,
  );
  static const TextStyle style_black_13 = TextStyle(
    color: Colors.black,
    fontSize: 13,
  );
  static const TextStyle style_black_15 = TextStyle(
    color: Colors.black,
    fontSize: 15,
  );
  ...
  static const TextStyle style_FFAE2E_14 = TextStyle(
    color: ColorStyle.color_FFAE2E,
    fontSize: 14,
  );

  static const TextStyle style_FFAE2E_16 = TextStyle(
    color: ColorStyle.color_FFAE2E,
    fontSize: 16,
  );

  static const TextStyle style_FE8C28_11 = TextStyle(
    color: ColorStyle.color_FE8C28,
    fontSize: 11,
    height: 1.1,
  );
