...
class RankingItemWidget extends StatelessWidget {
  ...
  const RankingItemWidget({super.key, required this.ranking});
    ...
    return SizedBox(
      ...
      child: Flex(
        ...
        children: [
          Expanded(
            flex: 1,
            child: Center(child: _numberRankingWidget(int.parse(ranking.rank))),
          ),
          Expanded(
            flex: 1,
            child: Center(
  ...
  Widget _numberRankingWidget(int rank) {
    return rank == 1 || rank == 2 || rank == 3
        ? SvgPicture.asset(_getMedal(rank), width: 26)
        : Text(ranking.rank.toString(), style: Styles.style_black_16_bold);
  }
